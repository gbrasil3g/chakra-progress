  ...
  return (
    <CopyBlock
      ...
      export function Circular() {
        ...
        return (
          <Box bg="#e5e5e5" width="300px" height="230px" align="center" display="flex" flexDirection="column">
            ...
            <Button onClick={() => handleRedirect('https://github.com/gbrasil3g')} width="100px" alignSelf="center" marginTop="15px" marginBottom="8px">Source code</Button>
